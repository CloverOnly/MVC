...
@WebServlet("/news.nhn")
@MultipartConfig(maxFileSize=1024*1024*2, location="C:\\Temp") //이미지 주소 후에 바꿀것
public class NewsController extends HttpServlet {
	...
	//웹 리소스 기본 경로 지정
	private final String START_PAGE = "news/newsList.jsp"; //경로 확인해볼것
