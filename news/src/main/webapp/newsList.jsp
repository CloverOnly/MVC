...
<div class="container w-75 mt-5 mx-auto">
	...
	<ul class="list-group">
		<c:forEach var="news" items="${newslist }" varStatus="status">
			<li class="list-group-item list-group-item-action d-flex justify-content-between aligen-items-center">
...
<!-- 			form action 경로 확인해볼것 -->
			<form method="post" action="/news/news.nhn?action=addNews" enctype="multipart/form-data">
